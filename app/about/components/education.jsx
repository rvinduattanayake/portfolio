	...
	const educationHistory = [
		{
			...
			institution: "Higher National Diploma in Information & Communication Technology (HNDICT)",
			subtitle: "Currently Studying",
			description:
				"Currently pursuing my Higher National Diploma in ICT, building on the foundation from my Foundation Certificate and deepening my expertise in software engineering and systems development.",
		},
		{
			period: "Feb 2024 - Nov 2024",
			institution: "SLIIT City University",
			subtitle: "Foundation Certificate in Information Technology (FCIT)",
			description:
				"Completed the Foundation Certificate in Information Technology (FCIT), covering Mathematics, Computer Systems, Programming, Application Software Development, Systems Analysis and Design, Project Management, and Academic & English Communication.",
		},
		{
			period: "2008 - 2022",
			institution: "St. Sylvester's College",
			subtitle: "Primary & Secondary Education",
			description:
				"Completed my primary and secondary education, building the foundational academic base that led into pursuing further studies in Information Technology.",
		},
	];
		...
		2024: [
			{
				...
				title: "Completed Foundation Certificate in IT",
				subtitle: "Foundation Certificate in Information Technology (FCIT) - SLIIT City University",
				date: "Nov 2024",
			...
			<section className="grid gap-8 md:gap-12">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					...
					<motion.div
						...
						<div className="gap-4 mb-6 flex items-stretch md:h-[300px] xl:h-[400px]">
						...
						<div className="space-y-6">
							{educationHistory.map((edu, index) => (
								<div
									...
									<p className="text-gray-600 text-justify title text-base">
										{edu.description}
									</p>
								</div>
							))}
