...
import Me from "@/public/image/alvalen-front.jpeg";
...
function ScrollIndicator() {
	...
	useEffect(() => {
		const handleScroll = () => {
			if (window.scrollY > window.innerHeight / 2) setDismissed(true);
		};
				...
				<div className="mx-auto w-[82%] max-w-screen-2xl grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden">
					<motion.div
						...
						<motion.p
							...
							Hi! I&rsquo;am Ravindu, a Computer Science and
							Software Engineering undergraduate student with a
							strong interest in full-stack web development and
				...
				<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
						...
						<motion.p
							...
							<a href="mailto:rvinduattanayake@gmail.com?subject=Hello&body=Hello Ravindu,">
								rvinduattanayake@gmail.com
							</a>
						</motion.p>
						{/* icons */}
						<div className="flex justify-center items-center space-x-4">
							<motion.a
								href="mailto:rvinduattanayake@gmail.com?subject=Hello&body=Hello Ravindu,"
							...
							<motion.a
								href="https://github.com/rvinduattanayake"
								target="_blank"
								rel="noopener noreferrer"
							...
							<motion.a
								href="https://www.linkedin.com/in/ravindu02"
								target="_blank"
								rel="noopener noreferrer"
							...
							<motion.a
								href="https://discord.com/users/1536077830612590632"
								target="_blank"
								rel="noopener noreferrer"
